...
<body>
    ...
    <div class="content form">
        <form class="form-border" method="POST" action="tutorRegValidation.php">
            <fieldset>
                <legend>
                    <h3 class="form-heading">Tutor Registration Form</h3>
                </legend>
                <table>
                    <tr>
                        <td>UserName : </td>
                    ...
                    <tr>
                        ...
                        <td><a class="btn-sm btn btn-danger ms-3 px-4" href="tutorLogin.php">Login</a></td>
                    </tr>
