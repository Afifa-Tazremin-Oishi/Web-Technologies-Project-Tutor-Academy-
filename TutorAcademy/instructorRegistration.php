...
<body>
    ...
    <div class="content form">
        <form class="form-border" method="POST" action="instructorRegValidation.php">
            <fieldset>
                <legend>
                    <h3 class="form-heading">Instructor Registration Form</h3>
                </legend>
                <table>
                    <tr>
                        <td>UserName : </td>
                    ...
                    <tr>
                        ...
                        <td><a class="btn-sm btn btn-danger ms-3 px-4" href="instructorLogin.php">Login</a></td>
                    </tr>
